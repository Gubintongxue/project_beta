...
static void InitDefaultsscc_info_GetFriendListRequest_test2_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetFriendListRequest_test2_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetFriendListRequest_test2_2eproto}, {}};

static void InitDefaultsscc_info_GetFriendListResponse_test2_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendListResponse_test2_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFriendListResponse_test2_2eproto}, {
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_test2_2eproto_sccs[6] = {
  &scc_info_GetFriendListRequest_test2_2eproto.base,
  &scc_info_GetFriendListResponse_test2_2eproto.base,
...
static bool descriptor_table_test2_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test2_2eproto = {
  &descriptor_table_test2_2eproto_initialized, descriptor_table_protodef_test2_2eproto, "test2.proto", 418,
...
static bool dynamic_init_dummy_test2_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_test2_2eproto), true);
namespace fixbug {
...
const GetFriendListRequest& GetFriendListRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListRequest_test2_2eproto.base);
  return *internal_default_instance();
}
...
void GetFriendListResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListResponse_test2_2eproto.base);
  result_ = nullptr;
}
